...
<body>
    <?php
        ...
        if (isset($_POST["firefighter_quantity"])) {
            session_start();
            $_SESSION["firefighter_quantity"] = $_POST["firefighter_quantity"];
        }
...
<h2>Firefighter Duckie</h2>
    ...
    <div>
        ...
        <div class="addToCart_button">
            <form action="firefighter_duckie.php" method="post">
                <select name="firefighter_quantity">
                    <option value="">Choose quantity</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                </select>
            <input type="submit" id="firefighter_btn" value="Add to cart">
